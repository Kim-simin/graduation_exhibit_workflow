...
doc_content = """# 📚 LangChain Docs MCP 연결 및 검증 결과 보고서 (LANGCHAIN_DOCS_MCP_TEST.md)
...
with open("LANGCHAIN_DOCS_MCP_TEST.md", "w", encoding="utf-8") as f:
    f.write(doc_content.strip() + "\n")

print("Created LANGCHAIN_DOCS_MCP_TEST.md successfully!")
